...
<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu">
    <li><a href='<?= base_url('admin/register/rp3mum/edit/'.$list['id']) ?>' class="text-right">Edit &nbsp;&nbsp;<i class="glyphicon glyphicon-pencil"></i></a></li>
    <li><a href='<?= base_url() ?>admin/register/rp3mum/geledah' class="text-right">Sprint Geledah &nbsp;&nbsp;<i class="glyphicon glyphicon-plus text-red"></i></a></li>
    <li role="separator" class="divider"></li>
    <li><a href='<?= base_url() ?>admin/register/rp3mum/naik_dik_sus' class="text-right text-red"><strong>Dik-Sus &nbsp;&nbsp;<i class="glyphicon glyphicon-share-alt text-red"></i></strong></a> </li>
  </ul>
...
<div class="panel-collapse collapse" role="tabpanel" id="collapse1" aria-labelledby="headingOne" aria-expanded="false" style="height: 0px;">
	...
	<div class="col-lg-8 col-md-8 col-sm-12">
		<table class="table table-responsive table-striped">
			<tbody>
				<tr>
					<td><?php include_once '_tsk4.php' ?>;</td>
				</tr>
				<tr>
					<td><?php include_once '_tsk12.php' ?>;</td>
				</tr>
				<tr>
					<td><?php include_once '_tsk5.php' ?>;</td>
				</tr>
			</tbody>
		</table>
	</div>
