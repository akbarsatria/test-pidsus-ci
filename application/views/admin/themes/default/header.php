    ...
    <li class="footer">
      <a href="#">View all tasks</a>
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?= base_url() ?>assets/admin/dist/img/warih.jpeg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Warih Sadono SH. MH</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($this->uri->segment(2)=="home"){echo "active";}?> treeview">
              ...
              <ul class="treeview-menu">
                <li <?php if($this->uri->segment(3)=="dashboard"){echo 'class="active"';}?>><a href="<?= base_url() ?>admin/home/dashboard"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                <li <?php if($this->uri->segment(3)=="dashboard1"){echo 'class="active"';}?>><a href="<?= base_url() ?>admin/home/dashboard1"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
              </ul>
            </li>
